...
@section('content')
    ...
    <head>
        <script src="admin_assets/js/funcoes/acessorio.js"></script>
    </head>
        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-2">
                <div class="card-header py-3">
                    <div class="row">
                        <div class="col-md-8">
                            <h6 class="m-0 font-weight-bold text-primary">Cadastrar Acessório</h6>
                        </div>
                    </div>
                </div>
                <div class="card-body">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Lista de Acessórios</h6>
                </div>
                <div class="card-body">
