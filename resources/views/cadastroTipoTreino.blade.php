...
@section('content')
    ...
    <head>
        <script src="admin_assets/js/funcoes/tipoTreino.js"></script>
    </head>
    ...
    <head>
        ...
        <title>Cadastrar Tipo de Treino</title>
    </head>
        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-2">
                <div class="card-header py-3">
                    <div class="row">
                        <div class="col-md-8">
                            <h6 class="m-0 font-weight-bold text-primary">Cadastrar Tipo de Treino</h6>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                                ...
                                <input type="text" class="form-control" id="txtDescricao" name="txtDescricao"
                                    placeholder="Informe a descrição do Tipo de Treino">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-12">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Lista de Tipos de Treino</h6>
                </div>
                <div class="card-body">
